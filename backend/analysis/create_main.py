...
import json 
import os 
from .extractor import extract_zip, get_all_files, clone_repo 
...
def analyze_application(source_path): 
    ...
    if source_path.startswith("http://") or source_path.startswith("https://"): 
        print("[Analysis] GitHub URL detected. Cloning...") 
        extract_path = clone_repo(source_path) 
    else: 
        print("[Analysis] ZIP file detected. Extracting...") 
...
if __name__ == "__main__": 
        print("Usage: python -m backend.analysis.main <zip-file-or-github-url>") 
        sys.exit(1) 
